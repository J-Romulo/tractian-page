...
export default function Footer() {
  ...
  return (
    <footer className="bg-blue-950 px-4 py-12 lg:py-20 h-191">
      <div className="mx-auto flex w-full max-w-6xl flex-col">
        ...
        <div className="flex flex-col-reverse justify-between lg:flex-row">
          <div className="flex flex-col items-center gap-y-4 lg:items-start">
            <Logo className="w-36 lg:w-40" fill="#FFFFFF" />
            ...
            <Link
              ...
              className="flex items-center gap-x-2 text-sm text-slate-50 hover:underline"
            >
